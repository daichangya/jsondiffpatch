...
On html you will see moves as fancy curved arrows (check [Live Demo](https://jsdiff.com) ), these are implemented using SVG elements and an embedded script tag, they will only show up [if your browser supports SVG](http://caniuse.com/svg)
